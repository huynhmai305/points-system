...
import {FaInfoCircle, FaMapMarker, FaPhone, FaEnvelope, FaRegClock} from 'react-icons/fa'
      ...
      <section id="contact">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
            ...
            <span>
              <FaInfoCircle> Trường ĐH Tài Nguyên và Môi Trường Tp.HCM</FaInfoCircle>
              <FaMapMarker> 236B, Lê Văn Sỹ, phường 1, quận Tân Bình, Tp.Hồ Chí Minh</FaMapMarker>
            </span>
            <p>
              <abbr title="Phone"><FaPhone/></abbr> (123) 456-7890
            </p>
            <p>
              <abbr title="Email"><FaEnvelope/></abbr>
              <a href="mailto:huynhmai305@gmail.com">huynhmai305@gmail.com </a>
            </p>
            <p>
              <abbr title="Hours"><FaRegClock/></abbr>
